...
TestFilters([], function () {
    describe('Azure PolicyGroup Template', function () {
        ...
        it('Azure PolicyGroup Template', function () {
            ...
            cy.createPolicyGroupTemplate('DRAFT', awsPolicyGroupTemplateName, awsPolicyGroupTemplateDesc, 'Custom policy for Microsoft Azure Resources created with Terraform')
            ...
            cy.createPolicyGroupTemplate('PUBLISHED', awsPolicyGroupTemplateName, awsPolicyGroupTemplateDesc, 'Custom policy for Microsoft Azure Resources created with Terraform')
            utils.assertSucessMsg(this.testdata.policyGroupTemplateCreatedSucessMsg)
